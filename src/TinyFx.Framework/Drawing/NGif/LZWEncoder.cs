...
{
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“LZWEncoder”的 XML 注释
    public class LZWEncoder
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“LZWEncoder”的 XML 注释
    {
        ...
        //----------------------------------------------------------------------------
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“LZWEncoder.LZWEncoder(int, int, byte[], int)”的 XML 注释
        public LZWEncoder(int width, int height, byte[] pixels, int color_depth)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“LZWEncoder.LZWEncoder(int, int, byte[], int)”的 XML 注释
        {
            imgW = width;
            imgH = height;
            pixAry = pixels;
        ...
        //----------------------------------------------------------------------------
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“LZWEncoder.Encode(Stream)”的 XML 注释
        public void Encode(Stream os)
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“LZWEncoder.Encode(Stream)”的 XML 注释
        {
