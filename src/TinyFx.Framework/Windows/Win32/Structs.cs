...
public struct SYSTEMTIME
{
    ...
    public static SYSTEMTIME FromDateTime(DateTime dt)
    {
        ...
        ret.wYear = (Int16)dt.Year;
        ret.wMonth = (Int16)dt.Month;
        ret.wDayOfWeek = (Int16)dt.DayOfWeek;
        ret.wDay = (Int16)dt.Day;
        ret.wHour = (Int16)dt.Hour;
        ret.wMinute = (Int16)dt.Minute;
        ret.wSecond = (Int16)dt.Second;
        ret.wMilliseconds = (Int16)dt.Millisecond;
        return ret;
    }
}
