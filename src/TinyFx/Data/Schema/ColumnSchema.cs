...
namespace TinyFx.Data.Schema
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ColumnSchema<TEngineType, IDbType> : ColumnSchema
        ...
        where IDbType : struct
    {
        ...
        /// 默认值
        /// </summary>
        public object OrmDefaultValue
            => (HasDefaultValue && !string.IsNullOrEmpty(DefaultValue))
            ? SchemaUtil.ParseDefaultValue(DbDataProvider, DotNetTypeString, DotNetType, DefaultValue)
            : null;
    }
}
