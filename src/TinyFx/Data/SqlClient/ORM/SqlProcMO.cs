...
{
    public abstract class SqlProcMO<TEntity> : DbTableMO<SqlDatabase, SqlParameter, SqlDbType, TEntity>
         where TEntity : IRowMapper<TEntity>
    {
        ...
        public SqlProcMO(SqlDatabase database) { Database = database; }
        ...
        public SqlProcMO(string connectionString, int commandTimeout) 
            : this(new SqlDatabase(connectionString, commandTimeout)) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name = "connectionStringName">连接字符串名称</param>
        public SqlProcMO(string connectionStringName = null)
