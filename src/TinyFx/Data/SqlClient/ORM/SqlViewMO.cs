...
{
    public abstract class SqlViewMO<TEntity> : DbViewMO<SqlDatabase, SqlParameter, SqlDbType, TEntity>
         where TEntity : IRowMapper<TEntity>
    {
        ...
        public SqlViewMO(SqlDatabase database) { Database = database; }
        ...
        public SqlViewMO(string connectionString, int commandTimeout) 
            : this(new SqlDatabase(connectionString, commandTimeout)) { }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name = "connectionStringName">连接字符串名称</param>
        public SqlViewMO(string connectionStringName = null)
