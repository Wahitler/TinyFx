...
namespace TinyFx.Data
{
    public static partial class DbUtil
    {
        ...
        public static IEnumerable<T> MapToMutil<T>(this DataTable table, Func<IDataReader, T> rowMapper = null)
            => MapToMutil<T>(table.CreateDataReader(), rowMapper);
        public static IEnumerable<T> MapToMutil<T>(this DataTable table, DataMappingMode mode)
            => MapToMutil<T>(table.CreateDataReader(), mode);
        /// <summary>
