...
namespace TinyFx.Data
{
    ...
    internal class CommandParametersCache
    {
        ...
        public void Set(CommandWrapper command, Database database)
        {
            ...
            //IDataParameter[] paras = new IDataParameter[command.Parameters.Count];
            //command.Parameters.CopyTo(paras, 0);
            //this._cache[key] = CloneParameters(paras, database);
        }
        ...
        public IDataParameter[] Get(CommandWrapper command, Database database)
        {
            ...
            //IDataParameter[] paras = (IDataParameter[])(this._cache[key]);
            //return CloneParameters(paras, database);
        }
