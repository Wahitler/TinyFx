...
namespace TinyFx.Data
{
    ...
    public interface IDao : IDisposable
    {
        ...
        /// <param name="mode"></param>
        /// <returns></returns>
        IEnumerable<T> ExecMutil<T>(DataMappingMode mode);
        /// <summary>
        /// 执行SQL语句并返回实体对象(T)枚举集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="tm"></param>
        /// <returns></returns>
        IEnumerable<T> ExecMutil<T>(DataMappingMode mode, TransactionManager tm);
        /// <summary>
        /// 执行SQL语句并返回实体对象(T)枚举集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="rowMapper"></param>
        /// <returns></returns>
        IEnumerable<T> ExecMutil<T>(Func<IDataReader, T> rowMapper);
        /// <summary>
        /// 执行SQL语句并返回实体对象(T)枚举集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="tm"></param>
        /// <returns></returns>
        IEnumerable<T> ExecMutil<T>(Func<IDataReader, T> rowMapper, TransactionManager tm);
        /// <summary>
        /// 执行SQL语句并返回实体对象(T)枚举集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="tm"></param>
        /// <returns></returns>
        IEnumerable<T> ExecMutil<T>(TransactionManager tm);
        /// <summary>
        /// 执行SQL语句并返回受影响的行数
        /// </summary>
        /// <param name="tm"></param>
