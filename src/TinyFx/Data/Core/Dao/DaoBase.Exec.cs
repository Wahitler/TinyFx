...
namespace TinyFx.Data
{
    public abstract partial class DaoBase
    {
        ...
        /// <param name="rowMapper">IDataReader对象到实体对象的映射方法，如果为null，则使用接口IRowMapper(T)或ColumnMapperAttribute定义的元数据通过反射获取实体对象</param>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>(Func<IDataReader, T> rowMapper, TransactionManager tm)
            => ExecReader(tm).MapToMutil(rowMapper);
        ...
        /// <param name="tm">数据库事务管理对象</param>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>(TransactionManager tm)
            => ExecMutil<T>(null, tm);
        ...
        /// <param name="rowMapper">IDataReader对象到实体对象的映射方法，如果为null，则使用接口IRowMapper(T)或ColumnMapperAttribute定义的元数据通过反射获取实体对象</param>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>(Func<IDataReader, T> rowMapper)
            => ExecMutil(rowMapper, null);
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>()
            => ExecMutil<T>(null, null);
        ...
        /// <param name="tm"></param>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>(DataMappingMode mode, TransactionManager tm)
            => ExecMutil(DbUtil.GetRowMapper<T>(mode), tm);
        ...
        /// <param name="mode"></param>
        /// <returns></returns>
        public IEnumerable<T> ExecMutil<T>(DataMappingMode mode)
            => ExecMutil(DbUtil.GetRowMapper<T>(mode), null);
        #endregion
