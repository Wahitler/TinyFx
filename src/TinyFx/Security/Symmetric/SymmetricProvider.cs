...
namespace TinyFx.Security
{
    ...
    public class SymmetricProvider
    {
        ...
        public SymmetricProvider(SymmetricMode symmetric, string key, byte[] iv = null, Encoding encoding = null)
            : this(symmetric, (encoding ?? Encoding.UTF8).GetBytes(key), iv, encoding)
        { }
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// <param name="iv">IV</param>
        /// <param name="encoding">字符集</param>
        public SymmetricProvider(SymmetricMode symmetric, byte[] key, byte[] iv = null, Encoding encoding = null)
        {
            switch (symmetric)
            {
