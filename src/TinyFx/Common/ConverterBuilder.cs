    ...
    public static class ConverterBuilder
    {
            ...
            where T : struct
        {
            return (value) =>
            {
                ...
                try
                {
                    ret = (value is T) ? (T)value : converter.Invoke(value);
                }
                catch
                {
                    ret = defaultValue;
        ...
        internal static Converter<object, DateTime> GetDateTimeConverter(string formart = null)
        {
            return (value) =>
            {
                ...
                return GetDateTimeStringConverter(formart).Invoke(Convert.ToString(value));
            };
        }
        ...
        private static Dictionary<string, bool> _booleanCache = new Dictionary<string, bool>() {
            { "FALSE",false},{ "0",false},{ "NO",false},{ "TRUE",true},{ "1",true},{ "YES",true}
        };
        /// <summary>
        /// String => Boolean转换器
        /// </summary>
