...
namespace TinyFx
{
    ...
    public static partial class StringUtil
    {
        ...
        public static T ToEnum<T>(this string src)
            where T : struct
            =>(T)Enum.Parse(typeof(T), src, true);
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        public static T ToEnum<T>(this string src, T defaultValue)
            where T : struct
            => string.IsNullOrEmpty(src) ? defaultValue : To(src, defaultValue, ToEnum<T>);
        ...
        /// <param name="src">源字符串</param>
        /// <returns></returns>
        public static T? ToEnumN<T>(this string src)
            where T : struct
            => ToN(src, ToEnum<T>);
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        public static T? ToEnumN<T>(this string src, T defaultValue)
            where T : struct
            => ToN(src, defaultValue, ToEnum<T>);
        #endregion
    }
}
