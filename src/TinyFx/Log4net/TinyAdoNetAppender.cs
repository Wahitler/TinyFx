...
{
    public class TinyAdoNetAppender : AdoNetAppender
    {
        /// <summary>
        ...
        protected override string ResolveConnectionString(out string connectionStringContext)
        {
            ...
            {
                var section = TinyFx.Configuration.TinyFxConfigManager.GetConfig<TinyFx.Configuration.Data.DataConfig>();
                if (section != null && !string.IsNullOrEmpty(section.DefaultConnectionString))
                    ConnectionStringName = section.DefaultConnectionString;
            }
            if (!string.IsNullOrEmpty(ConnectionStringName))
            {
                if (DbConfigManager.ExistConnectionStringName(ConnectionStringName))
                {
                    var config = DbConfigManager.GetConnectionStringConfig(ConnectionStringName);
                    switch (config.Provider)
                    {
                        case DbDataProvider.MySqlClient:
                            base.ConnectionType = "MySql.Data.MySqlClient.MySqlConnection, MySql.Data";
                            break;
                        case DbDataProvider.OracleClient:
                            base.ConnectionType = "System.Data.OracleClient.OracleConnection, System.Data.OracleClient";
                            break;
                        case DbDataProvider.SqlClient:
                            base.ConnectionType = "System.Data.SqlClient.SqlConnection, System.Data";
                            break;
                        case DbDataProvider.OleDb:
                            base.ConnectionType = "System.Data.OleDb.OleDbConnection, System.Data";
                            break;
                        case DbDataProvider.Odbc:
                            base.ConnectionType = "System.Data.Odbc.OdbcConnection, System.Data";
                            break;
                        case DbDataProvider.Odac:
                            base.ConnectionType = "Oracle.ManagedDataAccess.Client.OracleConnection, Oracle.ManagedDataAccess";
                            break;
                    }
    ...
    public class AdoNetAppender : BufferingAppenderSkeleton
    {
        ...
        virtual protected Type ResolveConnectionType()
        {
            try
            {
                return Type.GetType(ConnectionType, true, false);
