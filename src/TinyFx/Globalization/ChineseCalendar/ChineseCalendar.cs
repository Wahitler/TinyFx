...
namespace TinyFx.Globalization
{
    /// <summary>
    /// 中国阴历日期处理类
    /// </summary>
    public class ChineseCalendar
    {
        ...
        /// 获取当前日期的后一天
        /// </summary>
        public ChineseCalendar Next { get { return new ChineseCalendar(SolarDate.AddDays(1)); } }

        /// <summary>
        /// 获取当前日期的前一天
        /// </summary>
        public ChineseCalendar Previous { get { return new ChineseCalendar(SolarDate.AddDays(-1)); } }
        #endregion
