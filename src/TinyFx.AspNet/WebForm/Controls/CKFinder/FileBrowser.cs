...
namespace CKFinder
{
	...
	{
		private string CKFINDER_DEFAULT_BASEPATH => ResolveClientUrl("~/scripts/ckfinder/");
		public FileBrowser()
		{ }

		#region Properties

		[DefaultValue("~/scripts/ckfinder/")]
		public string BasePath
		{
			get
			{
				...
				return ( o == null ? ResolveClientUrl("~/scripts/ckfinder/") : (string)o );
			}
